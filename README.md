...
## 🌱 Skills
<img alt="my skills" src="https://skillicons.dev/icons?theme=light&perline=7&i=html,css,md,latex,astro,vite,react,git,github,gitlab,bitbucket,php,npm,flask,py,c,cpp,ruby,rails,java,js,ts,vscode,windows,linux,raspberrypi,docker,gmail,discord,nodejs,mysql,aws,sqlite,django,cmake"/>
<br>
